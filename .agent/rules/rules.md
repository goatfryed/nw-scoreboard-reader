...
- **Environment Configuration**: Always store configurations, secrets, crop coordinates, and frame-rate settings in the `.env` file rather than hardcoding them or forcing them solely as command-line options.
